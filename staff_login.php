...
$translations = [
    'en' => [
        ...
        'about' => 'About',
        'about_us' => 'About Us',
        'welcome_to' => 'Welcome to Braick Dispensary',
        'about_desc' => 'Committed to providing quality healthcare services with compassion and professionalism.',
        'our_mission' => 'Our Mission',
        'mission_desc' => 'To provide accessible, affordable, and quality healthcare services to our community.',
        'our_vision' => 'Our Vision',
        'vision_desc' => 'To be the leading healthcare provider known for excellence and compassion.',
    ],
    'sw' => [
        ...
        'welcome_to' => 'Karibu Braick Dispensary',
        'about_desc' => 'Tumejitolea kutoa huduma bora za afya kwa huruma na ustaarabu.',
        'our_mission' => 'Dhamira Yetu',
        'mission_desc' => 'Kutoa huduma za afya zinazopatikana, za bei nafuu, na za ubora kwa jamii yetu.',
        'our_vision' => 'Maono Yetu',
        'vision_desc' => 'Kuwa mtoa huduma bora wa afya anayejulikana kwa ubora na huruma.',
    ]
];
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .lang-btn.scrolled-lang {
            border-color: #E2E8F0;
            color: #1E293B;
            background: #F8FAFC;
        }
        .lang-btn.scrolled-lang:hover {
            background: #E2E8F0;
        }
        .lang-btn.scrolled-lang.active {
            background: var(--secondary);
            color: white;
            border-color: var(--secondary);
        }
        ...
        .hero-bg {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(135deg, rgba(11, 94, 215, 0.92) 0%, rgba(10, 76, 168, 0.88) 100%);
            z-index: 1;
        }
        .hero-bg::before {
            content: '';
            ...
            right: 0;
            bottom: 0;
            background: url('assets/images/dispensary-bg.jpg') center/cover no-repeat;
            opacity: 0.2;
            z-index: 0;
        }
        .hero .hero-content {
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-2">
                ...
                <div class="flex items-center gap-1 ml-2">
                    ...
                    <a href="?lang=sw" class="lang-btn <?= $lang == 'sw' ? 'active' : '' ?>">SW</a>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 lg:hidden">
                <div class="flex items-center gap-1">
                    <a href="?lang=en" class="lang-btn <?= $lang == 'en' ? 'active' : '' ?>" style="padding: 4px 8px; font-size: 0.65rem;">EN</a>
                    <a href="?lang=sw" class="lang-btn <?= $lang == 'sw' ? 'active' : '' ?>" style="padding: 4px 8px; font-size: 0.65rem;">SW</a>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="hero-content">
                ...
                <div class="search-wrapper mb-6">
                    <input type="text" placeholder="Search services, doctors..." id="searchInput">
...
<section id="services" class="section bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="section-subtitle mx-auto"><?= __('services_sub') ?></p>
        </div>
        
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="service-card">
                <div class="service-icon icon-blue"><i class="fas fa-user-md"></i></div>
                <h4 class="font-bold text-gray-800 text-lg mb-2"><?= __('general_consultation') ?></h4>
                <p class="text-gray-500 text-sm"><?= __('general_consultation_desc') ?></p>
            </div>
            <div class="service-card">
                <div class="service-icon icon-green"><i class="fas fa-flask"></i></div>
                <h4 class="font-bold text-gray-800 text-lg mb-2"><?= __('laboratory_services') ?></h4>
                <p class="text-gray-500 text-sm"><?= __('laboratory_services_desc') ?></p>
            </div>
            <div class="service-card">
                <div class="service-icon icon-purple"><i class="fas fa-pills"></i></div>
                <h4 class="font-bold text-gray-800 text-lg mb-2"><?= __('pharmacy_services') ?></h4>
                <p class="text-gray-500 text-sm"><?= __('pharmacy_services_desc') ?></p>
            </div>
            <div class="service-card">
                <div class="service-icon icon-orange"><i class="fas fa-heartbeat"></i></div>
                <h4 class="font-bold text-gray-800 text-lg mb-2"><?= __('health_checkups') ?></h4>
                <p class="text-gray-500 text-sm"><?= __('health_checkups_desc') ?></p>
            </div>
            <div class="service-card">
                <div class="service-icon icon-red"><i class="fas fa-users"></i></div>
                <h4 class="font-bold text-gray-800 text-lg mb-2"><?= __('family_healthcare') ?></h4>
                <p class="text-gray-500 text-sm"><?= __('family_healthcare_desc') ?></p>
            </div>
            <div class="service-card">
                <div class="service-icon icon-teal"><i class="fas fa-ambulance"></i></div>
                <h4 class="font-bold text-gray-800 text-lg mb-2"><?= __('emergency_care') ?></h4>
                <p class="text-gray-500 text-sm"><?= __('emergency_care_desc') ?></p>
            </div>
        </div>
    </div>
</section>
...
<section id="appointment" class="section">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="section-subtitle mx-auto"><?= __('appointment_sub') ?></p>
        </div>
...
<section id="contact" class="section bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="section-subtitle mx-auto"><?= __('contact_sub') ?></p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="contact-card">
                ...
                <h4 class="font-semibold text-gray-800"><?= __('phone') ?></h4>
                <p class="text-gray-600 text-sm">+255 759 154 160</p>
                <p class="text-gray-600 text-sm">+255 675 751 799</p>
            </div>
            <div class="contact-card">
                <div class="cc-icon" style="background: rgba(10, 168, 79, 0.08); color: #0AA84F;">
                    <i class="fas fa-envelope"></i>
                </div>
                <h4 class="font-semibold text-gray-800"><?= __('email') ?></h4>
                <p class="text-gray-600 text-sm">info@braickdispensary.com</p>
                <p class="text-gray-600 text-sm">support@braickdispensary.com</p>
            </div>
            <div class="contact-card">
                <div class="cc-icon" style="background: rgba(139, 92, 246, 0.08); color: #8B5CF6;">
                    <i class="fas fa-map-marker-alt"></i>
                </div>
                <h4 class="font-semibold text-gray-800"><?= __('location') ?></h4>
                <p class="text-gray-600 text-sm">Chang'ombe, Dodoma</p>
                <p class="text-gray-600 text-sm">City Centre, Mbeya</p>
            </div>
            <div class="contact-card">
                <div class="cc-icon" style="background: rgba(245, 158, 11, 0.08); color: #F59E0B;">
                    <i class="fas fa-clock"></i>
                </div>
                <h4 class="font-semibold text-gray-800"><?= __('working_hours') ?></h4>
                <p class="text-gray-600 text-sm">Mon-Fri: 8AM - 6PM</p>
                <p class="text-gray-600 text-sm">Sat: 8AM - 2PM</p>
                <p class="text-gray-600 text-sm">Sun: Closed</p>
            </div>
        </div>
        
        <!-- Google Map -->
        <div class="mt-8 bg-white rounded-2xl shadow-lg p-4 border">
            <div class="w-full h-64 rounded-xl overflow-hidden">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31656.435607676727!2d35.739166!3d-6.1625!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMDknNDUuMCJTIDM1wrA0NCcyMC4wIkU!5e0!3m2!1sen!2stz!4v1700000000000"
...
<script>
    ...
    window.addEventListener('scroll', () => {
        if (window.scrollY > 50) {
            ...
            langBtns.forEach(btn => btn.classList.add('scrolled-lang'));
        } else {
            navbar.classList.remove('scrolled');
            brandText?.classList.add('text-white');
            brandText?.classList.remove('text-gray-800');
            langBtns.forEach(btn => btn.classList.remove('scrolled-lang'));
        }
    });
