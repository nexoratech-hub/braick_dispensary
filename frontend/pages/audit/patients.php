...
// AUDIT - PATIENTS REPORT (VIEW ONLY - FOR AUDIT ROLE)
// ✅ Allow both admin and audit roles
// ✅ View button TU kwenye Actions
...
console.log('%c📋 Patients Report - VIEW ONLY', 'font-size:16px; font-weight:bold; color:#0B5ED7;');
console.log('%c✅ Role: <?= $user_role ?>', 'font-size:12px; color:#34D399;');
console.log('%c✅ View button TU kwenye actions', 'font-size:12px; color:#34D399;');
