...
// ✅ Inaonyesha visit info, patient, doctor, diagnosis, vitals, 
//    bill, lab tests, prescriptions, procedures, payments
// ================================================================
...
.action-bar .action-info .info-icon { width: 42px; height: 42px; border-radius: 12px; background: var(--warning-bg); color: var(--warning); display: flex; align-items: center; justify-content: center; font-size: 1.1rem; }
