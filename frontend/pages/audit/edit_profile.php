<?php
// ================================================================
// FILE: frontend/pages/audit/edit_profile.php
// AUDIT - EDIT PROFILE
...
$user_specialty = $_SESSION['specialty'] ?? 'Audit Officer';
        ...
        if (empty($errors)) {
            ...
            try {
                ...
                $stmt->execute([
                    $user_id,
                    $user_branch_id,
                    "Audit profile updated: " . $full_name
                ]);
            } catch (Exception $e) {}
    ...
    if ($action === 'update_avatar') {
        if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] === UPLOAD_ERR_OK) {
            ...
            if (!in_array($file_ext, $allowed_exts)) {
                ...
                $filename = 'audit_' . $user_id . '_' . time() . '.' . $file_ext;
                ...
                if (move_uploaded_file($file['tmp_name'], $filepath)) {
                    ...
                    try {
                        ...
                        $stmt->execute([
                            $user_id,
                            $user_branch_id,
                            "Audit profile picture updated for: " . $user_full_name
                        ]);
                    } catch (Exception $e) {}
        ...
        try {
            ...
            try {
                ...
                $stmt->execute([
                    $user_id,
                    $user_branch_id,
                    "Audit profile picture removed for: " . $user_full_name
                ]);
            } catch (Exception $e) {}
...
<head>
    ...
    <title>Edit Profile - Braick Audit</title>
...
<main class="main-content">
    ...
    <div class="page-header">
        <div class="page-header-left">
            <h1 class="page-title">
                ...
                <span class="page-badge audit-badge">🛡️ Audit Mode</span>
            </h1>
            <p class="page-subtitle">
                Update your audit profile information
    ...
    <div class="row-2col">
        ...
        <div class="consultation-card">
            <h3 class="card-title">
                <i class="fas fa-user-shield title-blue"></i> Personal Information
            </h3>
            ...
            <form method="POST" action="" id="profileForm">
                ...
                <div class="form-row">
                    ...
                    <p class="help-text">e.g. Audit Officer, Senior Auditor, Compliance Officer</p>
                </div>
...
<script>
    ...
    console.log('%c🛡️ Braick - Audit Edit Profile', 'font-size:18px; font-weight:bold; color:#0B5ED7;');
    console.log('%c👤 Audit User: <?= htmlspecialchars($user_full_name) ?>', 'font-size:13px; color:#059669;');
    console.log('%c🛡️ Role: <?= $_SESSION['role'] ?>', 'font-size:13px; color:#D97706;');
    ...
    console.log('%c🔒 Session-based login active', 'font-size:13px; color:#64748B;');
</script>
