<?php
// ================================================================
// FILE: frontend/pages/audit/all_procedures.php
// AUDIT - ALL PROCEDURES & EQUIPMENTS FOR A PATIENT (VIEW ONLY)
...
@media print {
    .btn-header, .view-only-notice, .action-group, .table-nav-group { display: none !important; }
...
<main class="main-content">
    ...
    <div class="view-only-notice">
        ...
        <span class="notice-text">
            You are viewing procedures & equipments in <strong>VIEW ONLY</strong> mode. 
