...
// ================================================================
// ✅ GET LAB TEST DETAILS - LAZIMISHA BRANCH YA MTUMIAJI
// ================================================================
$test = null;
try {
    $sql = "SELECT 
    ...
    $stmt = $db->prepare($sql);
    $stmt->execute([$test_id, $selected_branch_id]);
...
<script>
console.log('%c🔍 Audit - View Lab Test', 'font-size:18px;font-weight:bold;color:#0B5ED7;');
