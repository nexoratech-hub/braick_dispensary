...
<main class="main-content">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">
                ...
                Karibu, <span class="user-tag"><i class="fas fa-user"></i> <?= htmlspecialchars($user_full_name) ?></span>
    ...
    <div class="stats-grid-8">
        ...
        <!-- CARD 3: PRESCRIPTION (GROSS, BILA ROUND OFF) -->
...
console.log('%c🔍 Audit Dashboard - BRANCH LOCKED', 'font-size:18px; font-weight:bold; color:#0B5ED7;');
...
console.log('%c⭐ Premium: <?= $currency ?> <?= number_format($stats['premium_revenue'], 2, '.', ',') ?>', 'font-size:12px; color:#7C3AED;');
</script>
