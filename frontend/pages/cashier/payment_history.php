...
<nav class="top-nav">
    <div class="flex items-center gap-4 flex-1">
        ...
        <div class="search-wrapper">
            ...
            <input type="text" id="searchInput" placeholder="Search payments..." value="<?= htmlspecialchars($search) ?>">
                    ...
                    <?php if (is_array($payments) && count($payments) > 0): ?>
                        <?php $i = 1; foreach ($payments as $payment): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="font-mono text-xs" style="color:#64748B;">
                                        <?= htmlspecialchars($payment['bill_number'] ?? 'N/A') ?>
                                    </span>
                                </td>
                                <td>
                                    <div class="font-medium text-sm" style="color:#1E293B;">
                                ...
                                <td>
                                    <span class="text-xs font-mono" style="color:#94A3B8;"><?= htmlspecialchars($payment['reference_number'] ?? 'N/A') ?></span>
                                </td>
                                <td>
                                    <span class="text-sm" style="color:#475569;"><?= htmlspecialchars($payment['received_by_name'] ?? 'N/A') ?></span>
                                </td>
                                <td class="text-xs" style="color:#94A3B8;">
                                    <?= isset($payment['received_at']) ? date('d/m/Y', strtotime($payment['received_at'])) : 'N/A' ?>
                                    <br>
                                    <span class="text-[0.6rem]" style="color:#CBD5E1;">
...
<script>
    ...
    console.log('%c💰 Total Amount: <?= $currency ?> <?= number_format($total_amount, 0) ?>', 'font-size:13px; color:#059669;');
