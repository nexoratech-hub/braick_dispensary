...
try {
    ...
    // CALCULATE TOTALS
    // ================================================================
    $total_bills = count($partial_bills);
    $total_partial = 0;
...
<nav class="top-nav">
    <div class="flex items-center gap-4 flex-1">
        ...
        <div class="search-wrapper">
            ...
            <input type="text" id="searchInput" placeholder="Search partial payments..." value="<?= htmlspecialchars($search) ?>">
...
<main class="main-content">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">
                ...
                Manage partial payments in <strong><?= htmlspecialchars($branch_name) ?></strong>
    ...
    <div class="card" style="max-width:1200px;margin:0 auto;">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-list" style="color:#7C3AED;"></i> Partial Payments List
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="10" class="text-center py-8 text-gray-400">
                                <i class="fas fa-hand-holding-usd text-3xl block mb-2 text-gray-300"></i>
                                <p class="text-lg">No partial payments</p>
                                <p class="text-sm">
                                    <?php if ($filter !== 'all'): ?>
                                        No partial payments found for the selected date range
                                    <?php else: ?>
                                        All bills are either fully paid or pending
                                    <?php endif; ?>
                                </p>
                            </td>
                        </tr>
...
<script>
    ...
    console.log('%c💳 Braick - Partial Payments (With Filters)', 'font-size:18px; font-weight:bold; color:#7C3AED;');
    ...
    console.log('%c❌ Removed Total Balance card', 'font-size:13px; color:#DC2626;');
