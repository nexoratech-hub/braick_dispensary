...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            // Log activity
            logActivity($db, $_SESSION['user_id'], 'patient_updated', "Patient updated: $full_name (ID: {$patient['patient_id']})");
...
// ================================================================
// GET DOCTORS FOR SELECTED BRANCH (via AJAX)
// ================================================================
// This will be used by the JavaScript to load doctors when branch changes
