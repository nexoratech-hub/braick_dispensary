    ...
    <div class="form-card animate-fade-in-up" style="animation-delay:0.1s;">
        <div class="form-header">
            ...
            <div>
                ...
                <p class="form-subtitle">Enter payment details for <?= htmlspecialchars($bill['item_name'] ?? 'this item') ?></p>
            </div>
        </div>
...
<script>
    ...
    console.log('%c📋 Bill: <?= $bill['bill_number'] ?>', 'font-size:13px; color:#64748B;');
    console.log('%c👤 Patient: <?= $bill['patient_name'] ?>', 'font-size:13px; color:#64748B;');
