...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($form_data['name'])) {
        ...
        if ($stmt->fetch()) {
            ...
            if ($stmt->execute([$form_data['name'], $form_data['description'], $form_data['head_of_department'], $form_data['status']])) {
                ...
                echo '<script>setTimeout(function(){ window.location.href = "departments.php"; }, 1500);</script>';
            } else {
...
<style>
    ...
    .form-card:hover {
        border-color: #7B2FBE;
        box-shadow: 0 8px 30px rgba(123, 47, 190, 0.08);
    }
...
<main class="main-content">
    ...
    <div class="page-header flex flex-wrap justify-between items-center gap-3 mb-5">
        <div>
            <h1 class="page-title">
                <i class="fas fa-plus-circle mr-2" style="color: #7B2FBE;"></i> Add New Department
            </h1>
    ...
    <div class="form-card">
        ...
        <div class="form-header">
            ...
            <div>
                ...
                <p>Enter the details of the new department</p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="form-label">
                        <i class="fas fa-tag text-purple-600"></i> Department Name
                ...
                <div>
                    <label class="form-label">
                        <i class="fas fa-user-tie text-purple-600"></i> Head of Department
                    </label>
                    <div class="form-row-icon">
                ...
                <div class="md:col-span-2">
                    <label class="form-label">
                        <i class="fas fa-align-left text-purple-600"></i> Description
                    </label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
        <div class="tip-card">
            ...
            <div class="tip-text">
                <h4>Tip #1</h4>
                <p>Choose a unique department name</p>
            </div>
        </div>
        <div class="tip-card">
...
<script>
    ...
    console.log('%c🏢 Braick - Add Department', 'font-size:18px; font-weight:bold; color:#7B2FBE;');
