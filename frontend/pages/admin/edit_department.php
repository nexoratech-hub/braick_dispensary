...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) {
        ...
        if ($stmt->execute([$name, $description, $head_of_department, $status, $dept_id])) {
...
<head>
    ...
    <title>Edit Department - Braick Dispensary</title>
...
<main class="main-content">
    <div class="page-header flex flex-wrap justify-between items-center gap-3 mb-5">
        <div>
            <h1 class="page-title"><i class="fas fa-edit mr-2" style="color: var(--blue-600);"></i> Edit Department</h1>
            <p class="page-subtitle">Update department information</p>
        </div>
        <div>
            <a href="departments.php" class="btn btn-outline btn-sm"><i class="fas fa-arrow-left"></i> Back to Departments</a>
        </div>
    </div>
        ...
        <form method="POST" action="">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="head_of_department" class="form-control" value="<?= htmlspecialchars($department['head_of_department'] ?? '') ?>">
                </div>
            ...
            <div class="flex gap-3 mt-6 pt-4 border-t">
                <button type="submit" class="btn btn-blue"><i class="fas fa-save"></i> Update Department</button>
                <a href="departments.php" class="btn btn-outline"><i class="fas fa-times"></i> Cancel</a>
            </div>
        </form>
    </div>
