...
/* ============================================================
   ✅ TABLE NAVIGATION < > BUTTONS (SLIDE LEFT/RIGHT)
   ============================================================ */
.table-nav-group {
    display: inline-flex;
    align-items: center;
...
.btn-action-sm.edit:hover { background: #B45309; }
                                ...
                                <div class="visit-section">
                                    <div class="visit-section-header">
                                        ...
                                        <div class="visit-stats-right">
                                            ...
                                            <!-- ✅ TABLE NAVIGATION < > (SLIDE LEFT/RIGHT) -->
...
function togglePatient(patientId) {
    ...
    // ✅ Update table nav baada ya expand (kwa sababu table ilikuwa hidden)
    setTimeout(function() {
        if (body) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (firstBody) {
        setTimeout(function() {
            ...
            // ✅ Update table nav for first patient
...
function scrollTable(tableId, direction) {
    ...
    var scrollAmount = 300; // pixels kwa kila click
    ...
    // Update indicator baada ya scroll
    setTimeout(function() {
...
// ================================================================
// ✅ UPDATE TABLE NAV (indicator % + button disabled states + fade)
// ================================================================
function updateTableNav(tableId) {
    var table = document.getElementById(tableId);
    if (!table) return;
    
    // Extract unique id (format: table-PATIENTID-VISITID)
...
// Re-init baada ya window resize
...
(function() {
    ...
    function filterAll(query) {
        ...
        // ✅ Update table nav baada ya search (kwa sababu rows zinaweza kubadilika)
