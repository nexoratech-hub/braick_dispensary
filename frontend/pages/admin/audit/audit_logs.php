<?php
// ================================================================
// FILE: frontend/pages/admin/audit/audit_logs.php
// AUDIT - SYSTEM ACTIVITY LOGS REPORT (V2 - WITH DELETE)
...
// ✅ Blue theme: #0B5ED7
// ✅ PDF Export
// ✅ Namba kamili (849,600 badala ya 849.6K)
// ================================================================
...
console.log('%c📋 Audit Logs V2 (With Delete)', 'font-size:18px; font-weight:bold; color:#0B5ED7;');
console.log('%c✅ Delete single log', 'font-size:13px; color:#DC2626; font-weight:bold;');
console.log('%c✅ Delete All with filters', 'font-size:13px; color:#DC2626; font-weight:bold;');
