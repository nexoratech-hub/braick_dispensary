<?php
// ================================================================
// FILE: frontend/pages/admin/audit/view_bill.php
// ADMIN AUDIT - VIEW BILL DETAILS (FIXED CALCULATIONS)
// ✅ Recalculates total from subtotal - discount + premium
// ✅ Ensures discount is properly reflected
// ✅ Blue theme #0B5ED7
// ✅ Print & PDF export
// ================================================================
...
// ================================================================
// ✅ FIXED CALCULATIONS: Discount inahesabika
// ================================================================
...
// ✅ CALCULATE ITEM-LEVEL DISCOUNT TOTAL (from bill_items)
...
// ✅ EFFECTIVE DISCOUNT = max ya total_discount na sum ya discounts
...
// ✅ USE CALCULATED TOTAL (sio DB)
$total_amount = $calculated_total;

// ✅ Check discrepancy kati ya DB na calculation
...
$created_by_pic_url = !empty($bill['created_by_pic'])
    ? '/dispensary_system/frontend/assets/uploads/profiles/' . $bill['created_by_pic']
    : '/dispensary_system/frontend/assets/uploads/profiles/default_avatar.png';
...
[data-theme="dark"] .discrepancy-alert .alert-text .mono {
...
<main class="main-content">
    ...
    <div class="page-header">
        ...
        <div style="display:flex;gap:6px;flex-wrap:wrap;position:relative;z-index:1;">
            ...
            <a href="edit_bill.php?id=<?= $bill_id ?>&branch=<?= $selected_branch_id ?>" class="btn-header">
    ...
    <div class="discrepancy-alert">
        ...
        <div class="alert-text">
            <strong>Note:</strong> Total imerekebishwa kutoka DB value. 
            DB ilikuwa <span class="mono"><?= $currency ?> <?= number_format($db_total_amount, 0) ?></span>, 
            calculation ni <span class="mono"><?= $currency ?> <?= number_format($total_amount, 0) ?></span>.
            <br>
    ...
    <div class="action-bar">
        <div class="action-info">
            ...
            <div class="info-text">
                <div class="info-title">Bill Actions</div>
                <div class="info-sub">View, edit, or manage this bill</div>
            </div>
        </div>
        <div class="action-buttons">
            ...
            <a href="edit_bill.php?id=<?= $bill_id ?>&branch=<?= $selected_branch_id ?>" class="btn btn-edit">
...
<script>
console.log('%c📄 View Bill - Audit (FIXED)', 'font-size:18px; font-weight:bold; color:#0B5ED7;');
...
<?php if ($has_discrepancy): ?>
console.log('%c⚠️ DISCREPANCY: DB=<?= number_format($db_total_amount, 0) ?>, Calc=<?= number_format($total_amount, 0) ?>', 'font-size:13px; color:#D97706; font-weight:bold;');
<?php endif; ?>
</script>
