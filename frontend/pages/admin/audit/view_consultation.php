<?php
// ================================================================
// FILE: frontend/pages/admin/audit/view_consultation.php
// ADMIN/ADMIN AUDIT - VIEW CONSULTATION DETAILS
// ✅ Inaonyesha visit info, patient, doctor, diagnosis, prescription
// ✅ Inaonyesha bill info + payments
// ✅ Inaonyesha lab tests, procedures, medications zote za visit
// ================================================================
...
<main class="main-content">
    ...
    <div class="info-card">
        <div class="card-header">
            ...
            <a href="view_bill.php?id=<?= $bill['id'] ?>&branch=<?= $selected_branch_id ?>" 
               class="btn-action-sm view" style="text-decoration:none;background:var(--primary);color:white;padding:6px 14px;border-radius:8px;font-size:0.7rem;font-weight:700;">
    ...
    <div class="action-bar">
        <div class="action-info">
            ...
            <div class="info-text">
                <div class="info-title">Consultation Actions</div>
                <div class="info-sub">
                    <?php if ($is_admin): ?>
                        View or edit this consultation
                    <?php else: ?>
        ...
        <div class="action-buttons">
            ...
            <?php if ($is_admin): ?>
                <a href="edit_consultation.php?id=<?= $visit_id ?>&branch=<?= $selected_branch_id ?>" class="btn btn-primary">
...
<script>
console.log('%c🩺 View Consultation', 'font-size:18px;font-weight:bold;color:#0B5ED7;');
...
console.log('%c✅ Doctor: Dr. <?= htmlspecialchars($visit['doctor_name'] ?? 'N/A') ?>', 'font-size:13px;color:#34D399;');
