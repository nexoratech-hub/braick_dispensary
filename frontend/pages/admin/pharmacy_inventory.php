...
<script>
    ...
    console.log('%c📦 Braick Dispensary - Pharmacy Inventory', 'font-size:18px; font-weight:bold; color:#0B5ED7;');
    ...
    console.log('%c✅ Filter: instock, lowstock, outofstock, expired, expiring', 'font-size:13px; color:#34D399;');
</script>
