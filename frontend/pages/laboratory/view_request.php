...
<head>
    ...
    <title>View Request - Laboratory</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        [data-theme="dark"] .test-status-badge.pending { background: #3D2E0A; color: #FBBF24; }
        [data-theme="dark"] .test-status-badge.in_progress { background: #1E3A5F; color: #6EA8FE; }
        [data-theme="dark"] .test-status-badge.completed { background: #1A3A2A; color: #34D399; }
        ...
        @media (max-width: 480px) {
            ...
            .btn { padding: 4px 10px; font-size: 0.65rem; }
            .form-control { padding: 4px 8px; font-size: 0.75rem; }
        }
    </style>
</head>
<body>
