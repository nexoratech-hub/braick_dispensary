...
try {
    ...
    // ================================================================
    // ✅ GET LAB TEST DETAILS - Using visit_id and test_id
    // ================================================================
    $sql = "
        SELECT lt.*, 
    ...
    // ================================================================
    // ✅ GET TEST CATALOG DETAILS (if not already joined)
    // ================================================================
    $test_catalog = null;
    ...
    // ================================================================
    // ✅ GET ALL LAB TESTS FOR THIS VISIT (for navigation)
    // ================================================================
    $visit_lab_tests = [];
...
<main class="main-content">
    ...
    <div class="card animate-fade-in-up" style="padding:12px 16px;">
        <div class="test-nav">
            <span style="font-size:0.7rem;font-weight:600;color:var(--text-secondary);padding:4px 8px;">
            ...
            ?>
                <a href="lab_tests.php?id=<?= $test['id'] ?>" 
                   class="test-nav-item <?= $is_active ? 'active' : $status_class ?>">
                    #<?= $test['id'] ?> <?= htmlspecialchars(substr($test['test_name'], 0, 20)) ?>
                    <?php if ($is_active): ?>
    ...
    <div class="grid-2">
        ...
        <div class="card animate-fade-in-up" style="animation-delay:0.1s;">
            ...
            <div class="info-row">
                ...
                <span class="info-value">
                    <strong>TSh <?= number_format($lab_test['test_price'] ?? 0, 0) ?></strong>
                </span>
            </div>
            <div class="info-row">
        ...
        <div class="card animate-fade-in-up" style="animation-delay:0.15s;">
            ...
            <div class="info-row">
                ...
                <span class="info-value">
                    ...
                    <?php else: ?>
                        <span class="badge badge-purple">🧪 Lab Only (No Doctor)</span>
                    <?php endif; ?>
                </span>
            </div>
            <?php if (!empty($lab_test['doctor_name'])): ?>
        ...
        <div class="card animate-fade-in-up" style="animation-delay:0.2s;">
            ...
            <div class="info-row">
                ...
                <span class="info-value">
                    ...
                    <?php else: ?>
                        <span class="text-gray-400"><i class="fas fa-info-circle"></i> Not assigned</span>
                    <?php endif; ?>
                </span>
            </div>
    ...
    <div class="card text-center py-12">
        ...
        <a href="assign_doctor.php" class="btn btn-primary mt-4">
            <i class="fas fa-arrow-left"></i> Back
        </a>
    </div>
...
<script>
    ...
    console.log('%c🔬 Braick - Lab Test Details', 'font-size:18px; font-weight:bold; color:#2563EB;');
    ...
    console.log('%c📋 Visit ID: <?= $lab_test['visit_id'] ?? 'N/A' ?>', 'font-size:13px; color:#64748B;');
    console.log('%c✅ Uses visit_id and test_id to view lab test details', 'font-size:13px; color:#34D399;');
</script>
