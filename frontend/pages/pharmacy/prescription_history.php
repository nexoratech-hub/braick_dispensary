...
<!-- ================================================================ -->
<!-- PAGE-SPECIFIC STYLES - ZINAONGEZWA KWENYE HEADER -->
<!-- ================================================================ -->
<style>
    :root {
        --primary: #0B5ED7;
    ...
    /* ================================================================
       MAIN CONTENT - INAZIDISHA MARGIN KWA SIDEBAR
       ================================================================ */
    .main-content {
        margin-left: 270px;
        margin-top: 68px;
    ...
    /* ================================================================
       RESPONSIVE - INAZINGATIA SIDEBAR
       ================================================================ */
...
<script>
    ...
    console.log('%c📋 Braick - Prescription History (FIXED - Shared Header)', 'font-size:18px; font-weight:bold; color:#0B5ED7;');
